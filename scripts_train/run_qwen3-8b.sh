...
EXP_NAME=DrGRPO_OrderI_math_qwen3-8B
WANDB_PROJECT="DrGRPO_OrderI"

MODEL_PATH=${ROOT}/base_models/Qwen3-8B
CKPTS_DIR=${ROOT}/checkpoints/${WANDB_PROJECT}/${EXP_NAME}
TRAIN_DATA_FILES=${ROOT}/data/DAPO-Math-17k-Processed/all/dapo-17k-processed-no-think.parquet
TEST_DATA_FILES=${ROOT}/data/aime-2024.parquet
