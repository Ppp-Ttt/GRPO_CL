...
MODEL_PATH=${ROOT}/checkpoints/DrGRPO/DrGRPO_math_chem_qwen3-8B/global_step_130/hf_model
OUTPUT_DIR=${ROOT}/eval_results/DrGRPO/DrGRPO_math_chem_qwen3-8B_step130/chem
